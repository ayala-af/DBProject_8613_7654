...
prompt Created on Sunday, July 7, 2024 by Naama
set feedback off
set define off
...
alter table CLIENTS disable constraint SYS_C007802;
prompt Disabling foreign key constraints for GROUPS_...
alter table GROUPS_ disable constraint SYS_C007805;
prompt Disabling foreign key constraints for PARTICIPATE...
alter table PARTICIPATE disable constraint SYS_C007809;
alter table PARTICIPATE disable constraint SYS_C007810;
prompt Disabling foreign key constraints for TEACHERS...
alter table TEACHERS disable constraint SYS_C007817;
prompt Disabling foreign key constraints for SCHEDULER...
alter table SCHEDULER disable constraint SYS_C007823;
alter table SCHEDULER disable constraint SYS_C007824;
alter table SCHEDULER disable constraint SYS_C007825;
alter table SCHEDULER disable constraint SYS_C007826;
prompt Disabling foreign key constraints for TEACH...
alter table TEACH disable constraint SYS_C007832;
alter table TEACH disable constraint SYS_C007833;
...
alter table CLIENTS enable constraint SYS_C007802;
prompt Enabling foreign key constraints for GROUPS_...
alter table GROUPS_ enable constraint SYS_C007805;
prompt Enabling foreign key constraints for PARTICIPATE...
alter table PARTICIPATE enable constraint SYS_C007809;
alter table PARTICIPATE enable constraint SYS_C007810;
prompt Enabling foreign key constraints for TEACHERS...
alter table TEACHERS enable constraint SYS_C007817;
prompt Enabling foreign key constraints for SCHEDULER...
alter table SCHEDULER enable constraint SYS_C007823;
alter table SCHEDULER enable constraint SYS_C007824;
alter table SCHEDULER enable constraint SYS_C007825;
alter table SCHEDULER enable constraint SYS_C007826;
prompt Enabling foreign key constraints for TEACH...
alter table TEACH enable constraint SYS_C007832;
alter table TEACH enable constraint SYS_C007833;
