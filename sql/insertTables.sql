...
insert into AYALA.AGE_GROUP (AGE_ID,MINAGE,MAXAGE,DESCRIPT)
...
insert into AYALA.CITY (CITY_NUM, CITY_NAME)
values (1, 'Archbold');
...
insert into AYALA.CLIENTS (CLIENT_ID, CLIENT_FNAME, CLIENT_LNAME, CLIENT_ADDR, CLIENT_TEL, CLIENT_PAYMENT, BIRTHDAY)
...
insert into AYALA.WORKSHOPS (WORKSHOP_ID,WORKSHOP_NAME, WORKSHOP_PRICE, WORKSHOP_HOURS, WORKSHOP_CAPACITY)
...
--INTO TEACHERS
insert into AYALA.TEACHERS (TEACHER_ID, TEACHER_FNAME, TEACHER_LNAME, TEACHER_ADDR, TEACHER_TEL, TEACHER_SALARY, TEACHER_JOIN_DATE)
...
--INTO GROUPS
insert into AYALA.GROUPS_ (GROUP_ID, AMOUNT, AGE_ID)
values (1, 10, 3);
...
--into rooms
insert into AYALA.ROOMS (ROOM_ID, ROOM_FLOOR, ISSTUDIO, ROOM_CAPACITY)
values (1, 4, 'F', 28);
...
--scheduler
insert into AYALA.SCHEDULER (SC_TIME, SC_DAY, SCHEDULER_ID, GROUP_ID, WORKSHOP_ID, ROOM_ID, TEACHER_ID)
...
--participate
insert into AYALA.PARTICIPATE (GROUP_ID, CLIENT_ID)
values (1, 1);
...
insert into AYALA.TEACH (WORKSHOP_ID, TEACHER_ID)
values (1, 1);
